...
exports.seed = function (knex, Promise) {
  ...
  return knex('encounters').del()
    ...
    {id:4, patient_id: 1, doctor_id: 1, date: '2018/09/27', time: '4:00 pm', hx:{}
    },
    {id:5, patient_id: 1, doctor_id: 1, date: '2018/09/28', time: '4:00 pm', hx:{}
    },
    {id:6, patient_id: 1, doctor_id: 1, date: '2018/09/29', time: '4:00 pm', hx:{}
    },
    {id:7, patient_id: 1, doctor_id: 1, date: '2018/09/30', time: '4:00 pm', hx:{}
    }
  ])
    })
    .then(function () {
