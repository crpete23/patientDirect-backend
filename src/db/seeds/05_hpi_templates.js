exports.seed = function (knex, Promise) {
  ...
  return knex('hpi_templates').del()
    .then(function () {
      // Inserts seed entries
      return knex('hpi_templates').insert([
        {id: 1, cc: 'chest pain', doctor_id: 1, template: {
  'quality': {
    type: 'radio',
...
{id: 2, cc: 'shortness of breath', doctor_id: 1, template: {
"quality": {
type: 'radio',
choices: ['shallow', 'difficulty taking a deep breath'],
...
"alleviating factors": {
type: 'check',
choices: ['inhalers', 'resting', 'sitting up', 'nitrates', 'diuretics'],
label: 'What, if anything, makes your symptoms better? (select all that apply)'
},
"exacerbating factors": {
type: 'check',
choices: ['exertion', 'walking up incline', 'laying down', 'bending over', 'salt indiscretions'],
label: 'What, if anything, induces or makes your symptoms worse? (select all that apply)'
},
"associated symptoms": {
type: 'check',
choices: ['chest pain', 'leg edema', 'weight gain', 'orthopnea/PND', 'fatigue', 'dizziness/light headedness'],
...
{id: 3, cc: 'palpitations', doctor_id: 1, template: {
"quality": {
type: 'radio',
choices: ['hard/pounding', 'fast/racing', 'skipped beats', 'slow'],
...
"location": {
type: 'radio',
choices: ['chest', 'throat/neck'],
label: `What is the location of your palpitations?`,
other: true
},
"alleviating factors": {
type: 'check',
choices: ['time', 'rest', 'anti-anxiety medication', 'beta-blockers', 'pill in the pocket (antiarrhythmic medication)'],
label: 'What, if anything, makes your symptoms better? (select all that apply)'
},
"exacerbating factors": {
type: 'check',
...
"associated symptoms": {
type: 'check',
choices: ['shortness of breath', 'chest pain', 'diaphoresis (sweating)', 'nausea', 'vomitting', 'fatigue', 'dizziness/light headedness', 'syncope'],
